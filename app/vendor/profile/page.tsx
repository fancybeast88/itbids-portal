      ...
      <div className="p-6 max-w-2xl space-y-5">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-5">
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            {[['Company',vendor.companyName],['Contact',vendor.contactPerson],['Phone',vendor.phone||'—'],['City',vendor.city||'—'],['NTN',vendor.ntn||'—'],['Partner level',vendor.partnerLevel||'—'],['Brands',vendor.brands?.join(', ')||'—'],['Email',session.user?.email||'—']].map(([l,v]) => (
