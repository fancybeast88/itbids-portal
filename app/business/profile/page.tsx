...
function AdBanner() {
  return (
    <div className="rounded-xl border-2 border-dashed border-amber-300 bg-gradient-to-br from-amber-50 to-yellow-50 p-5 relative overflow-hidden">
      ...
      <div className="text-xs text-amber-800 leading-relaxed mb-3">
        Advertise your IT products and services here. Reach hundreds of verified IT vendors and procurement teams across Pakistan through Lead Vault.
      </div>
